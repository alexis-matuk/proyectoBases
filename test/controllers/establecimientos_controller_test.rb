...
class EstablecimientosControllerTest < ActionController::TestCase
  ...
  test "should create establecimiento" do
    assert_difference('Establecimiento.count') do
      post :create, establecimiento: { codpost: @establecimiento.codpost, direccion: @establecimiento.direccion, telefono: @establecimiento.telefono }
    end
  ...
  test "should update establecimiento" do
    patch :update, id: @establecimiento, establecimiento: { codpost: @establecimiento.codpost, direccion: @establecimiento.direccion, telefono: @establecimiento.telefono }
    assert_redirected_to establecimiento_path(assigns(:establecimiento))
  end
