...
class ReportesControllerTest < ActionController::TestCase
  ...
  test "should create reporte" do
    assert_difference('Reporte.count') do
      post :create, reporte: { clientes: @reporte.clientes, fecha: @reporte.fecha, ingreso: @reporte.ingreso }
    end
  ...
  test "should update reporte" do
    patch :update, id: @reporte, reporte: { clientes: @reporte.clientes, fecha: @reporte.fecha, ingreso: @reporte.ingreso }
    assert_redirected_to reporte_path(assigns(:reporte))
  end
