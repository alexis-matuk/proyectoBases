...
class InspectorsControllerTest < ActionController::TestCase
  ...
  test "should create inspector" do
    assert_difference('Inspector.count') do
      post :create, inspector: { departamento: @inspector.departamento, institucion: @inspector.institucion, telefono: @inspector.telefono }
    end
  ...
  test "should update inspector" do
    patch :update, id: @inspector, inspector: { departamento: @inspector.departamento, institucion: @inspector.institucion, telefono: @inspector.telefono }
    assert_redirected_to inspector_path(assigns(:inspector))
  end
