...
class ProveedorsControllerTest < ActionController::TestCase
  ...
  test "should create proveedor" do
    assert_difference('Proveedor.count') do
      post :create, proveedor: { email: @proveedor.email, nombre: @proveedor.nombre, representante: @proveedor.representante, telefono: @proveedor.telefono }
    end
  ...
  test "should update proveedor" do
    patch :update, id: @proveedor, proveedor: { email: @proveedor.email, nombre: @proveedor.nombre, representante: @proveedor.representante, telefono: @proveedor.telefono }
    assert_redirected_to proveedor_path(assigns(:proveedor))
  end
