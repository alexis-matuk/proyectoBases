...
class EmpleadosControllerTest < ActionController::TestCase
  ...
  test "should create empleado" do
    assert_difference('Empleado.count') do
      post :create, empleado: { cargo: @empleado.cargo, contratacion: @empleado.contratacion, nombre: @empleado.nombre, salario: @empleado.salario }
    end
  ...
  test "should update empleado" do
    patch :update, id: @empleado, empleado: { cargo: @empleado.cargo, contratacion: @empleado.contratacion, nombre: @empleado.nombre, salario: @empleado.salario }
    assert_redirected_to empleado_path(assigns(:empleado))
  end
